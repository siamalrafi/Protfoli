            ...
            <div className="hero m-5">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div className='lg:px-10  '>
                        <h1 className='w-full'>Hey! I am <b>Md Siam Al Rafi</b>, a full-stack developer. I am very interested in this sector. I think this will be a growing sector. I'm currently studying at Mymensingh Polytechnic Institute at power engineering.
                        </h1>
                        <p>
